...
Tuy nhiên có một vấn đề nhỏ. Thông thường khi ta dùng call win thì địa chỉ trả về lệnh tiếp theo (RIP) sẽ được đẩy vào stack (8 BYTE) và khi vào hàm sẽ push thêm RBP của hàm cha vào stack (8 BYTE). Tổng là 16 BYTE. Và thnah ghi xmm0 yêu cầu stack chia hết cho 16.
